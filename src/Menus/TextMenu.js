...
import { BoldIconBold, H1IconBold, H2IconBold, ItalicIconBold, QuoteIconBold } from "../icons/icons";
      ...
      <>
        ...
        editor={editor}>
              ...
              <IconButton
                ...
                ${editor.isActive('heading', { level: 1 })?activeColor:'text-gray-200'}`}
              >
                <H1IconBold size={22} />
              </IconButton>
              <IconButton
                ...
                ${editor.isActive('heading', { level: 2 })?activeColor:'text-gray-200'}`}
              >
                <H2IconBold size={22} />
              </IconButton>
                </>
