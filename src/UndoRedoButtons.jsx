...
const UndoRedoButtons = ({editor}) =>{
    ...
    return(
        <div className="flex flex ml-4 rounded" style={{pointerEvents:'all'}}>
                ...
                hover:text-royalblue-600 bg-transparent opacity-100 hover:bg-gray-50 tex-gray-800  duration-200 ease-in-out border-gray-200 transition`}>
            ...
            className={`text-base text-gray-700 hover:text-gray-900 border-l-0 focus:outline-none flex justify-center rounded font-bold cursor-default 
                hover:text-royalblue-600 bg-transparent opacity-100 hover:bg-gray-50  duration-200 ease-in-out border-gray-200 transition`}>
                <div className="flex my-auto mx-auto">
